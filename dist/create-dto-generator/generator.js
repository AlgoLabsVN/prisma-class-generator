...
exports.PrismaCreateDtoGenerator = exports.PrismaCreateDtoGeneratorOptions = exports.GENERATOR_NAME = void 0;
...
exports.PrismaCreateDtoGeneratorOptions = {
    makeIndexFile: {
...
class PrismaCreateDtoGenerator {
    constructor(options) {
        this.run = async () => {
        ...
        this.getConfig = () => {
            ...
            const result = {};
            for (const optionName in exports.PrismaCreateDtoGeneratorOptions) {
                const { defaultValue } = exports.PrismaCreateDtoGeneratorOptions[optionName];
    ...
    static getInstance(options) {
        ...
        PrismaCreateDtoGenerator.instance = new PrismaCreateDtoGenerator(options);
        return PrismaCreateDtoGenerator.instance;
    }
    getClientImportPath() {
...
exports.PrismaCreateDtoGenerator = PrismaCreateDtoGenerator;
