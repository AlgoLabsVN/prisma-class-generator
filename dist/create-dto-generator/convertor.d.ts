...
declare const primitiveMapToClassValidator: Record<DefaultPrismaFieldType, string>;
...
export type PrimitiveMapClassValidator = typeof primitiveMapToClassValidator[PrimitiveMapTypeKeys];
...
export declare class PrismaConvertor {
    ...
    get config(): Partial<Record<"makeIndexFile" | "dryRun" | "separateRelationFields" | "useSwagger" | "useClassValidator" | "useGraphQL" | "useUndefinedDefault" | "clientImportPath" | "useNonNullableAssertions" | "preserveDefaultNullable", any>>;
    set config(value: Partial<Record<"makeIndexFile" | "dryRun" | "separateRelationFields" | "useSwagger" | "useClassValidator" | "useGraphQL" | "useUndefinedDefault" | "clientImportPath" | "useNonNullableAssertions" | "preserveDefaultNullable", any>>);
    static getInstance(): PrismaConvertor;
    getPrimitiveMapTypeFromDMMF: (dmmfField: DMMF.Field) => PrimitiveMapTypeValues;
    getValidatorFromDMMF: (dmmfField: DMMF.Field) => PrimitiveMapClassValidator;
    ...
    extractClassValidatorDecoratorFromField: (dmmfField: DMMF.Field) => DecoratorComponent[];
