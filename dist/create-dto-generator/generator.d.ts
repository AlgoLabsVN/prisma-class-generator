...
export declare const PrismaCreateDtoGeneratorOptions: {
...
export type PrismaCreateDtoGeneratorOptionsKeys = keyof typeof PrismaCreateDtoGeneratorOptions;
export type PrismaCreateDtoGeneratorConfig = Partial<Record<PrismaCreateDtoGeneratorOptionsKeys, any>>;
export declare class PrismaCreateDtoGenerator {
    ...
    static getInstance(options?: GeneratorOptions): PrismaCreateDtoGenerator;
