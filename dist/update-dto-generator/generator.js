...
exports.PrismaUpdateDtoGenerator = exports.PrismaUpdateDtoGeneratorOptions = exports.GENERATOR_NAME = void 0;
...
exports.PrismaUpdateDtoGeneratorOptions = {
    makeIndexFile: {
...
class PrismaUpdateDtoGenerator {
    constructor(options) {
        this.run = async () => {
        ...
        this.getConfig = () => {
            ...
            const result = {};
            for (const optionName in exports.PrismaUpdateDtoGeneratorOptions) {
                const { defaultValue } = exports.PrismaUpdateDtoGeneratorOptions[optionName];
    ...
    static getInstance(options) {
        ...
        PrismaUpdateDtoGenerator.instance = new PrismaUpdateDtoGenerator(options);
        return PrismaUpdateDtoGenerator.instance;
    }
    getClientImportPath() {
...
exports.PrismaUpdateDtoGenerator = PrismaUpdateDtoGenerator;
