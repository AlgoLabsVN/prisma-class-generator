...
export const PrismaCreateDtoGeneratorOptions = {
	makeIndexFile: {
...
export type PrismaCreateDtoGeneratorOptionsKeys =
	keyof typeof PrismaCreateDtoGeneratorOptions
export type PrismaCreateDtoGeneratorConfig = Partial<
	Record<PrismaCreateDtoGeneratorOptionsKeys, any>
>

export class PrismaCreateDtoGenerator {
	static instance: PrismaCreateDtoGenerator
	...
	static getInstance(options?: GeneratorOptions) {
		if (PrismaCreateDtoGenerator.instance) {
			return PrismaCreateDtoGenerator.instance
		}
		PrismaCreateDtoGenerator.instance = new PrismaCreateDtoGenerator(
			options,
		)
		return PrismaCreateDtoGenerator.instance
	}
	...
	getConfig = (): PrismaCreateDtoGeneratorConfig => {
		const config = this.options.generator.config

		const result: PrismaCreateDtoGeneratorConfig = {}
		for (const optionName in PrismaCreateDtoGeneratorOptions) {
			const { defaultValue } = PrismaCreateDtoGeneratorOptions[optionName]
